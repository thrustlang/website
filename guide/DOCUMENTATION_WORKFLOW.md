...
The script copies the website to the output directory and rewrites internal root-relative links for `/website/assets/`, `/website/documentation/`, `/website/en/`, and `/website/es/`. The source checkout is not changed.
